...
var POSTPROCESSING = (() => {
  ...
  var BoxBlurMaterial = class extends import_three4.ShaderMaterial {
    ...
    set kernelSize(value) {
      ...
      this.defines.KERNEL_SIZE_SQ_HALF = (__pow(value, 2) / 2).toFixed(0);
  ...
  var dummyCamera = new import_three23.Camera();
  var geometry = null;
  ...
  var Pass = class {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        const isDisposable = property instanceof import_three23.WebGLRenderTarget || property instanceof import_three23.Material || property instanceof import_three23.Texture || property instanceof Pass;
        if (isDisposable) {
          this[key].dispose();
        }
      }
  ...
  var CopyPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputEncoding === import_three24.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three24.sRGBEncoding;
        }
      }
    }
  };
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three26.UnsignedByteType) {
          this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three26.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three26.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three26.sRGBEncoding;
        }
      }
    }
  };
  ...
  var color = new import_three27.Color();
  ...
  var AUTO_SIZE = -1;
  var Resolution = class extends import_three28.EventDispatcher {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      super();
      this.resizable = resizable;
      this.baseSize = new import_three28.Vector2(1, 1);
      this.preferredSize = new import_three28.Vector2(width, height);
      this.target = this.preferredSize;
      this.s = scale;
      this.effectiveSize = new import_three28.Vector2();
        ...
        if (node.isMesh) {
          ...
          if (node.material.flatShading) {
            switch (node.material.side) {
              case import_three29.DoubleSide:
                materials = this.materialsFlatShadedDoubleSide;
                break;
              case import_three29.BackSide:
    ...
    setMaterial(material) {
      ...
      if (material !== null) {
        ...
        for (const m2 of materials) {
          ...
          m2.side = import_three29.FrontSide;
        }
        materials[2].skinning = true;
        this.materialsBackSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three29.BackSide;
          return c2;
        });
        this.materialsDoubleSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three29.DoubleSide;
          return c2;
        });
  ...
  var DepthPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("DepthPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three30.MeshDepthMaterial({
        depthPacking: import_three30.RGBADepthPacking
      }));
      const renderPass = this.renderPass;
      renderPass.skipShadowMapUpdate = true;
      renderPass.ignoreBackground = true;
      const clearPass = renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three30.Color(16777215);
  ...
  var DepthCopyPass = class extends Pass {
    constructor({ depthPacking = import_three32.RGBADepthPacking } = {}) {
      super("DepthCopyPass");
      ...
      this.renderTarget = new import_three32.WebGLRenderTarget(1, 1, {
        type: depthPacking === import_three32.RGBADepthPacking ? import_three32.UnsignedByteType : import_three32.FloatType,
  ...
  var DepthPickingPass = class extends DepthCopyPass {
    constructor({ depthPacking = import_three33.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
      super({ depthPacking });
      this.name = "DepthPickingPass";
      this.fullscreenMaterial.mode = mode;
      this.pixelBuffer = depthPacking === import_three33.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
      this.callback = null;
    }
    readDepth(ndc) {
    ...
    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
      ...
      if (this.callback !== null) {
        ...
        const packed = renderTarget.texture.type !== import_three33.FloatType;
        let x = 0, y = 0;
...
`;
      ...
      if (mainImageExists) {
        if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
          fragmentMainImage += effect.inputColorSpace === import_three34.sRGBEncoding ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
        }
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    updateMaterial() {
      ...
      if (data.colorSpace === import_three34.sRGBEncoding) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.updateMaterial();
      if (frameBufferType !== void 0 && frameBufferType !== import_three34.UnsignedByteType) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
    dispose() {
  ...
  var GaussianBlurPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputEncoding === import_three35.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three35.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three35.sRGBEncoding;
        }
      }
    }
  };
  ...
  var LuminancePass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0 && frameBufferType !== import_three37.UnsignedByteType) {
        this.renderTarget.texture.type = frameBufferType;
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
  ...
  var MipmapBlurPass = class extends Pass {
    constructor() {
      ...
      this.resolution = new import_three38.Vector2();
    }
    get texture() {
      return this.renderTarget.texture;
    }
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three38.UnsignedByteType) {
          this.downsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
          this.upsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three38.sRGBEncoding) {
          for (const mipmap of mipmaps) {
            mipmap.texture.encoding = import_three38.sRGBEncoding;
          }
        }
      }
    }
  ...
  var NormalPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("NormalPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three39.MeshNormalMaterial());
      const renderPass = this.renderPass;
      renderPass.setBackgroundDisabled(true);
      renderPass.setShadowMapDisabled(true);
      const clearPass = renderPass.getClearPass();
      clearPass.setOverrideClearColor(new import_three39.Color(7829503));
      clearPass.setOverrideClearAlpha(1);
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three39.WebGLRenderTarget(1, 1, {
          minFilter: import_three39.NearestFilter,
          magFilter: import_three39.NearestFilter
        });
  ...
  var ShaderPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0 && frameBufferType !== import_three40.UnsignedByteType) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
  };
  ...
  var EffectComposer = class {
    ...
    setRenderer(renderer) {
      this.renderer = renderer;
      if (renderer !== null) {
        const size = renderer.getSize(new import_three41.Vector2());
        const alpha = renderer.getContext().getContextAttributes().alpha;
        const frameBufferType = this.inputBuffer.texture.type;
        if (frameBufferType === import_three41.UnsignedByteType && renderer.outputEncoding === import_three41.sRGBEncoding) {
          this.inputBuffer.texture.encoding = import_three41.sRGBEncoding;
          this.outputBuffer.texture.encoding = import_three41.sRGBEncoding;
          this.inputBuffer.dispose();
          this.outputBuffer.dispose();
        }
    ...
    createDepthTexture() {
      const depthTexture = this.depthTexture = new import_three41.DepthTexture();
      this.inputBuffer.depthTexture = depthTexture;
      this.inputBuffer.dispose();
      if (this.inputBuffer.stencilBuffer) {
        depthTexture.format = import_three41.DepthStencilFormat;
        depthTexture.type = import_three41.UnsignedInt248Type;
      } else {
        depthTexture.type = import_three41.UnsignedIntType;
      }
      return depthTexture;
    }
    deleteDepthTexture() {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const size = renderer === null ? new import_three41.Vector2() : renderer.getDrawingBufferSize(new import_three41.Vector2());
      const options = {
      ...
      let renderTarget;
      if (multisampling > 0) {
        renderTarget = Number(import_three41.REVISION.replace(/\D+/g, "")) < 138 ? new import_three41.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three41.WebGLRenderTarget(size.width, size.height, options);
        renderTarget.ignoreDepthForMultisampleCopy = false;
        renderTarget.samples = multisampling;
      } else {
        renderTarget = new import_three41.WebGLRenderTarget(size.width, size.height, options);
      }
      if (type === import_three41.UnsignedByteType && renderer !== null && renderer.outputEncoding === import_three41.sRGBEncoding) {
        renderTarget.texture.encoding = import_three41.sRGBEncoding;
      }
    ...
    addPass(pass, index) {
      ...
      const renderer = this.renderer;
      const drawingBufferSize = renderer.getDrawingBufferSize(new import_three41.Vector2());
      const alpha = renderer.getContext().getContextAttributes().alpha;
      const frameBufferType = this.inputBuffer.texture.type;
  ...
  var EffectShaderData = class {
    constructor() {
      ...
      this.colorSpace = import_three42.LinearEncoding;
    }
  };
  ...
  var Effect = class extends import_three44.EventDispatcher {
    constructor(name, fragmentShader, {
      ...
      this._inputColorSpace = import_three44.LinearEncoding;
  ...
  var BloomEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three45.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three45.sRGBEncoding;
        }
      }
    }
  };
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.SRC, brightness = 0, contrast = 0 } = {}) {
      ...
      this.inputColorSpace = import_three47.sRGBEncoding;
    }
    get brightness() {
  ...
  var DepthOfFieldEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three50.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three50.sRGBEncoding;
          this.renderTargetNear.texture.encoding = import_three50.sRGBEncoding;
          this.renderTargetFar.texture.encoding = import_three50.sRGBEncoding;
          this.renderTargetMasked.texture.encoding = import_three50.sRGBEncoding;
        }
      }
    }
  };
  ...
  var GodRaysEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three55.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three55.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three55.sRGBEncoding;
          this.renderTargetLight.texture.encoding = import_three55.sRGBEncoding;
        }
      }
    }
  };
  ...
  var LookupTexture = class extends import_three59.DataTexture3D {
    constructor(data, size) {
      super(data, size, size, size);
      this.type = import_three59.FloatType;
      this.format = import_three59.RGBAFormat;
      this.encoding = import_three59.LinearEncoding;
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three59.FloatType) {
        ...
        this.encoding = import_three59.sRGBEncoding;
        this.needsUpdate = true;
      } else {
  ...
  var LUT3DEffect = class extends Effect {
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          } else if (value instanceof import_three61.DataTexture3D) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof import_three61.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation) {
          if (lut instanceof import_three61.DataTexture3D) {
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three67.sRGBEncoding) {
          this.renderTargetMasked.texture.encoding = import_three67.sRGBEncoding;
        }
      }
    }
  };
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      this.renderTargetAO = new import_three70.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", tone_mapping_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["luminanceBuffer", new import_three72.Uniform(null)],
          ["maxLuminance", new import_three72.Uniform(maxLuminance)],
          ["whitePoint", new import_three72.Uniform(whitePoint)],
          ["middleGrey", new import_three72.Uniform(middleGrey)],
          ["averageLuminance", new import_three72.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three72.WebGLRenderTarget(1, 1, {
        minFilter: import_three72.LinearMipmapLinearFilter,
        depthBuffer: false
      });
  ...
  var VignetteEffect = class extends Effect {
    constructor({
      ...
      super("VignetteEffect", vignette_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["offset", new import_three73.Uniform(offset)],
          ["darkness", new import_three73.Uniform(darkness)]
        ])
      });
    }
    get technique() {
  ...
  var LUT3dlLoader = class extends import_three74.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
      const internalManager = new import_three74.LoadingManager();
      const loader = new import_three74.FileLoader(internalManager);
  ...
  var LUTCubeLoader = class extends import_three75.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
    ...
    parse(input) {
      ...
      const data = new Float32Array(__pow(size, 3) * 4);
      const domainMin = new import_three75.Vector3(0, 0, 0);
      const domainMax = new import_three75.Vector3(1, 1, 1);
  ...
  var SMAAImageLoader = class extends import_three76.Loader {
    load(onLoad = () => {
    }, onError = null) {
